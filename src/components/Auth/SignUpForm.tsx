            ...
            <div className="xl:ltr:pl-[90px] xl:rtl:pr-[90px] 2xl:ltr:pl-[120px] 2xl:rtl:pr-[120px] order-1 lg:order-2">
              ...
              <div className="my-[17px] md:my-[25px]">
                ...
                <p className="font-medium lg:text-md text-[#445164] dark:text-gray-400">
                  Start your journey to stress-free taxes
                </p>
              </div>
              ...
              <form onSubmit={handleSignUp}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="md:text-md block w-full text-center transition-all rounded-md font-medium my-[20px] md:my-[25px] py-[12px] px-[25px] text-white bg-purple-600 hover:bg-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <p className="!leading-[1.6]">
                ...
                <Link
                  href="#"
                  className="font-medium text-black dark:text-white transition-all hover:text-purple-500"
                >
                  Terms of Service
                </Link>{" "}
